...
5. Enforce explicit permanent closure evidence for Confirmed closed. A 404, active corporate registration, or functioning homepage alone is insufficient to establish service status. Provide a replacement URL only when supported by matching evidence.
